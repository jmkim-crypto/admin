    ...
    <section className="relative py-32 lg:py-48 bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          {/* Right: Mockup - Balanced Placement */}
          <div className="relative flex justify-center lg:justify-end">
            {/* Elegant Background Aura */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#00A3FF]/[0.03] rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="absolute bottom-[-100px] right-[-100px] w-[300px] h-[300px] bg-[#00A3FF]/[0.05] blur-[100px] -z-10" />
          </div>
