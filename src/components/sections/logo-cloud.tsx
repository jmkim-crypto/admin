...
export function LogoCloud() {
  ...
  return (
    <section ref={ref} className="relative py-16 lg:py-20 border-y border-[#E5E7EB]">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        <motion.p
          initial={{ opacity: 0 }}
          animate={isInView ? { opacity: 1 } : {}}
          transition={{ duration: 0.8 }}
          className="text-center text-xs text-[#9CA3AF] uppercase tracking-[0.2em] font-medium mb-10"
        >
          이미{" "}
          <span className="text-[#6B7280] font-semibold">500+</span> 제조 현장에서 검증되었습니다
        </motion.p>
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...logos, ...logos, ...logos].map((name, i) => (
              <div
                key={i}
                className="flex-shrink-0 px-5 py-2.5 rounded-lg bg-white/60 border border-[#F3F4F6]"
              >
